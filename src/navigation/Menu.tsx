...
import { clearData } from '../modules/data';
import { clearUsers } from '../modules/data';
import { logout } from '../modules/data';
      ...
      <Block paddingHorizontal={sizes.padding}>
       ...
       <Block
        ...
        {organizations?.map((organization, index) => (
          ...
          <View style={{ flexDirection: 'row', marginTop: 20 }}>
              <View style={{ flex: 1, alignItems: 'center' }}>
                  <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.secondary, paddingHorizontal: 10, paddingVertical: 5, borderRadius: 5 }} onPress={async () => {
